...
*/
$config['tables']['users']           = 'lakeland_users';
$config['tables']['groups']          = 'lakeland_groups';
$config['tables']['users_groups']    = 'lakeland_users_groups';
$config['tables']['login_attempts']  = 'lakeland_login_attempts';
